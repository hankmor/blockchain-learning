...
func TestTransfer(t *testing.T) {
	...
	// 接收地址
	recvAddr := "tb1pxhgt58augyx2cj2ldqnmyu0v6jgaum4g0j7smq6arvs43kxmwj6qfeylfs" // os.Getenv("addr")

	var utxos []string
	// 选择需要用到的UTXO，而不是全部
	inscriptionTxid := "9e186bebf95a556a32ea6e45ab65e1999107f34f23a255a332bd0eac38b86cbd"
	feeTxid := "a6984963fce39e6baba24bd0c25738082511d6ee4bae217b50a1b73b18d2fc29"
	utxos = append(utxos, inscriptionTxid)
	utxos = append(utxos, feeTxid)
	tool := NewPureInscriptionTool(net, btcApiClient)
