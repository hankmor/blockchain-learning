...
type Inscription struct {
	...
	SatOrdinal         uint64 `json:"sat_ordinal"`
	SatRarity          string `json:"sat_rarity"`
	SatCoinbaseHeight  uint64 `json:"sat_coinbase_height"`
...
func NewPureInscriptionTool(net *chaincfg.Params, client btcapi.BTCAPIClient) *InscriptionTool {
	tool := &InscriptionTool{
		net: net,
		client: &blockchainClient{
			btcApiClient: client,
